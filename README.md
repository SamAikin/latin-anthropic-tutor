...
Then daily lessons will worked through with the Sonnata model on Medium effort (caveat: if the model's responses are not fully clear in terms of grammatical concepts, translation corrections,
...
./lessons - the parent directory of each lesson directory (e.g., ./lessons/lesson-20260701/)
