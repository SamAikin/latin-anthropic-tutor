...
- Target roughly 30 minutes for the lesson — tight and focused beats long and sprawling.
...
As we wrap up, before the session ends you must:
- Write clean, complete `## Evaluation Notes` into this lesson's lesson-notes.md: what went well, what I struggled with, concepts that need reinforcement. This is key **STATE** for grading the homework later and for the next planning session.
- Update your ./claude-notes/ space with anything your learner model should remember from this lesson.
